...
// This class must exist in every scene
public class VRInput : MonoBehaviour
{
	...
	private float mSwipeThreshold = 25.0f; // Tune this to gage between click and swipe
	...
	private Vector2 mMouseMovevement;							// total movement of mouse from down to up
    ...
    private void CheckInput()
    {
        ...
        {
            // If anything has subscribed to OnPressed call it.
            if (OnPressed != null)
                OnPressed();
        }
    ...
    {
		mMouseMovevement = m_MouseUpPosition - m_MouseDownPosition;
		if (mMouseMovevement.magnitude > mSwipeThreshold) {
